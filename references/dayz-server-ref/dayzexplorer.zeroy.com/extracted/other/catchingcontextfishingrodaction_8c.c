// ======================================================================
// File: catchingcontextfishingrodaction_8c_source.html
// Category: other
// ======================================================================
...
float GetSignalPoissonMean() {return m_SignalPoissonMean;}
int GetSignalMax() {return Math.Ceil(m_SignalPoissonMean) + Math.Ceil(m_SignalPoissonMean/5);}
}