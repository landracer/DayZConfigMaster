// ======================================================================
// File: dayzplayercfgbase_8c_source.html
// Category: other
// ======================================================================
...
hmcs.m_fRunSpringTimeout = CfgGameplayHandler.GetMovementTimeToSprint();
hmcs.m_fRunSpringMaxChange = 8.0;
hmcs.m_fDirFilterTimeout = CfgGameplayHandler.GetMovementTimeToStrafeJog();
hmcs.m_fDirFilterSprintTimeout = CfgGameplayHandler.GetMovementTimeToStrafeSprint();
...
hmcs.m_fWaterLevelSpeedRectrictionLow = 0.5;
hmcs.m_fWaterLevelSpeedRectrictionHigh = 1.0;
hmcs.m_iMaxSpeedNormal_WaterLevelLow = -1;
hmcs.m_iMaxSpeedFast_WaterLevelLow = -1;
hmcs.m_iMaxSpeedNormal_WaterLevelHigh = 1;
hmcs.m_iMaxSpeedFast_WaterLevelHigh = 2;
//--------------------------------------------------------------
