// Source: F:/Games/Dayz/scripts/3_game/playerconstants.c Source File
...
class PlayerConstants 
{
    ...
    static const float STOMACH_DIGEST_AGENT_RANDOM_MIN = -0.5;  
    static const float STOMACH_DIGEST_AGENT_RANDOM_MAX = 0.5;   
    ...
    static const float  BLOODY_HANDS_SALMONELLA_CHANCE      = 0.05; 
