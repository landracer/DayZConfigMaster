...
- [ ] Workshop directory is auto-filled and shared across tabs
- [ ] Map dropdown shows both stock AND workshop maps  
- [ ] Mod selection correctly filters out map folders
- [ ] Mouse scroll wheel works on ANY content area (not just scrollbar)
- [ ] Multi-Instance tab map dropdown also shows workshop maps
